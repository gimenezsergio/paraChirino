...
COPY public.horarios_grilla (horgri_id, horgri_id_grilla, horgri_desde, horgri_hast) FROM stdin;
\.
...
SELECT pg_catalog.setval('public.grilla_grilla_id_seq', 1, false);
...
SELECT pg_catalog.setval('public.horarios_grilla_horgri_id_seq', 1, false);
...
SELECT pg_catalog.setval('public.medicos_medic_id_seq', 10, true);
...
SELECT pg_catalog.setval('public.turnos_turnos_id_seq', 1, false);
